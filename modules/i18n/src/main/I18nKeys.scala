...
val `partnerReq` = new Translated("partnerReq")
val `reqPartner` = new Translated("reqPartner")
val `partnered` = new Translated("partnered")
val `partner` = new Translated("partner")
val `unpartner` = new Translated("unpartner")
